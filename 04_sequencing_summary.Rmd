...
The table below shows sequencing coverage estimates for all 20 samples used for whole genome sequencing. Values are estimates from `samtools depth` based on the entire genome.  Samples used for MSMC analysis are indicated with a `*`.
